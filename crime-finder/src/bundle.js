...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thenRequest = __webpack_require__(172);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    key: 'handleSearch',
	    value: function handleSearch(offset) {
	      var _this2 = this;

	      // Make an AJAX request with the pageOffset
	      (0, _thenRequest2.default)('GET', 'http://104.236.160.123:3301/api/data?limit=' + this.limit + '&offset=' + offset).done(function (res) {
	        // Update state (crimes) with the results
	        _this2.setState({
	          crimes: JSON.parse(res.body)
	        });
	        console.log('crimes', _this2.state.crimes);
	      });
	    }
	  }, {
	    ...
	    value: function handlePageChange(e) {
	      ...
	      var newOffset = this.state.pageOffset;
	    ...
	    value: function render() {
	      return _react2.default.createElement(_Results2.default, { crimes: this.state.crimes, handlePageChange: this.handlePageChange });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Results = function Results(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_Table2.default, { crimes: props.crimes }),
	    _react2.default.createElement(_Controls2.default, { handlePageChange: props.handlePageChange })
	  );
	};
	...
	var Table = function Table(props) {
	  var headers = function () {
	    ...
	    if (props.crimes.length > 0) {
	      Object.keys(props.crimes[0]).forEach(function (key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controls = function Controls(props) {
	  return _react2.default.createElement(
	    "div",
	    null,
	    _react2.default.createElement("button", { id: "back-page", onClick: props.handlePageChange }),
	    _react2.default.createElement("button", { id: "next-page", onClick: props.handlePageChange })
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleQs = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parse = __webpack_require__(185).parse;
	var stringify = __webpack_require__(185).stringify;
